    ...
    return (
        <>
            <div className="Header">
                <div className="span">
                    <div className="title">
                        <img src={'https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=25&duration=6000&color=F2F2F2&center=true&vCenter=true&multiline=true&width=370&height=100&lines=%3C+Hello%2C+World!+%2F%3E'} alt="" />
                    </div>
                    <div className="hr"></div>
                    <div className="text">
                        <span>
                            Follow me in this story, in my story...
